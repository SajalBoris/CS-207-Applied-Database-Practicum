          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <?php
                ...
                if(isset($_POST['secret_field'])) $_SESSION['shop_id'] = $_POST['secret_field'];
                ...
                else
                {
                  ...
                  {
                    echo "<tr>";
                    $sql2 = "SELECT product_name , mrp FROM Product_Table WHERE product_id = ".$row['product_id'];
                    $result2 = mysqli_query($db, $sql2);
                    $row2 = mysqli_fetch_array($result2);
                    $pn = $row2['product_name'];
                    $mrp = $row2['mrp'];

                    echo "<td>".$row['product_id']."</td><td>".$pn."</td><td>".$mrp."</td><td>".$row['qty']."</td>";
